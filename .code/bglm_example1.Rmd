...
- $\beta_0$: Normal prior centred at 0 with a variance of 100
- $\beta_1$: Normal prior centred at 0 with a variance of 10
- $\sigma$: either a half cauchy centred at 0 with a variance of 5 or an
  exponential with parameter of 1
...
- $\beta_0$: normal centred at 164 with a standard deviation of 10
- $\beta_1$: normal centred at 0 with a standard deviation of 0.75
...
```{r fitModel3d1, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
library(INLAutils)
...
- **Probability Integral Transforms (PIT)** provides a version of CPO
  ...
  ```{r fitModel3e3, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
  plot(fert.inla1,
