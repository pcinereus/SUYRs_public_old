...
```{r fitModel1h1, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, fig.width = 5, fig.height = 3}
...
```{r fitModel2a2, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
fert.brm %>% names
```
...
```{r fitModel2c, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
median(fert$YIELD)
mad(fert$YIELD)
```
...
```{r fitModel2e1, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
fert.brm1 %>% ggpredict() %>% plot(add.data=TRUE)
```

#### ggemmeans

```{r fitModel2e2, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
fert.brm1 %>% ggemmeans(~FERTILIZER) %>% plot(add.data=TRUE)
```

#### conditional_effects

```{r fitModel2e3, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
...
```{r fitModel2i1, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
fert.brm2 %>%
    ggpredict() %>%
    plot(add.data=TRUE)
```
...
```{r fitModel2i2, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
fert.brm2 %>%
...
```{r fitModel2i3, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
fert.brm2 %>%
    conditional_effects() %>%
    plot(points = TRUE)
```
...
```{r fitModel2j2, results='markdown', eval=TRUE, echo = FALSE, hidden=TRUE}
...
```{r fitModel2k1, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
fert.brm3 %>%
    ggpredict() %>%
    plot(add.data=TRUE)
```
...
```{r fitModel2k2, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
fert.brm3 %>%
    ggemmeans(~FERTILIZER) %>%
    plot(add.data = TRUE)
```
...
```{r fitModel2k3, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
fert.brm3 %>%
    conditional_effects() %>%
    plot(points = TRUE)
```
...
```{r fitModel2k, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, fig.width = 8, fig.height = 4}
fert.brm3 %>% get_variables()
...
```{r fitModel3a, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
...
```{r fitModel3a2, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
fert.inla %>% names
```
...
```{r fitModel3b0, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, paged.print=FALSE,tidy.opts = list(width.cutoff = 80), echo=TRUE}
...
```{r fitModel3b3, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, paged.print=FALSE,tidy.opts = list(width.cutoff = 80)}
...
```{r fitModel3b1, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, paged.print=FALSE,tidy.opts = list(width.cutoff = 80)}
...
```{r fitModel3b5, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, paged.print=FALSE,tidy.opts = list(width.cutoff = 80)}
...
```{r fitModel3b9, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, paged.print=FALSE,tidy.opts = list(width.cutoff = 80)}
min(fert$YIELD)
median(fert$YIELD)
mad(fert$YIELD)
```
...
```{r fitModel3b8, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, paged.print=FALSE,tidy.opts = list(width.cutoff = 80)}
...
```{r fitModel3b4, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, paged.print=FALSE,tidy.opts = list(width.cutoff = 80)}
standist::visualize("normal(0, 5.102)", xlim=c(-20,20))
```

In order to define each of the above priors, we could modify the `inla` call:

```{r fitModel3b6, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
...
```{r fitModel3b7, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
## Fixed effects
...
```{r fitModel3d0, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
plot(fert.inla1,
...
```{r fitModel3d1, results='markdown', eval=TRUE, hidden=TRUE, fig.width = 6, fig.height = 3, cache=FALSE}
library(INLAutils)
plot_fixed_marginals(fert.inla1, priors = TRUE)
```
```{r fitModel3d1a, results='markdown', eval=TRUE, hidden=TRUE, fig.width = 3, fig.height = 3, cache=FALSE}
library(INLAutils)
plot_hyper_marginals(fert.inla1, CI = TRUE)
```
Or the effects as a single figure..

```{r fitModel3d1c, results='markdown', eval=TRUE, hidden=TRUE, fig.width = 6, fig.height = 6, cache=FALSE}
library(INLAutils)
autoplot(fert.inla1)
```

```{r fitModel3d2, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, fig.width=8}
...
```{r modelValidation1l, results='markdown', eval=TRUE, hidden=TRUE, fig.width=6, fig.height=9}
...
```{r fitModel3d1b, results='markdown', eval=TRUE, hidden=TRUE, fig.width = 6, fig.height = 6, cache=FALSE}
...
- **Conditional Predictive Ordinate (CPO)** is the density of the
  ...
  measure of fit.
  ```{r fitModel3e0, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
  fert.inla1$cpo$cpo
  ...
  ```{r fitModel3e1, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
...
- **Probability Integral Transforms (PIT)** provides a version of CPO
  ...
  ```{r fitModel3e3, results='markdown', eval=TRUE, hidden=FALSE, cache=FALSE}
  plot(fert.inla1,
...
```{r fitModel3e4, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
...
```{r fitModel3e5, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE}
...
```{r fitModel3f, results='markdown', eval=TRUE, hidden=TRUE, cache=FALSE, fig.width = 8}
...
```{r summariseModel1dd, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r summariseModel1d2, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
fert.rstanarm3$stanfit %>%
    summarise_draws(median,
...
```{r summariseModel1m, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r summariseModel1h, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r summariseModel2dd, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
fert.brm3 %>%
    summarise_draws(median,
                    HDInterval::hdi,
                    rhat, length, ess_bulk, ess_tail)
...
```{r summariseModel2d2, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
fert.brm3 %>%
    summarise_draws(median,
                    ~HDInterval::hdi(.x, credMass = 0.9),
                    rhat, length, ess_bulk, ess_tail)
...
```{r summariseModel2m, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r summariseModel2d1, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
fert.brm3 %>%
    ...
    median_hdci
```
```{r summariseModel2c1, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5,echo=FALSE}
fert.gather <- fert.brm3 %>%
    gather_draws(b_Intercept, b_FERTILIZER, sigma) %>%
    median_hdci
```

```{r summariseModel2c2, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5,echo=TRUE}
fert.brm3 %>% 
  gather_draws(b_Intercept, b_FERTILIZER, sigma) %>% 
  ggplot() + 
  stat_halfeye(aes(x = .value,  y = .variable)) +
...
```{r summariseModel2h, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
mcmcpvalue <- function(samp)
{
    ## elementary version that creates an empirical p-value for the
    ## hypothesis that the columns of samp have mean zero versus a
...
```{r summariseModel3a, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
fert.inla1 %>% summary()
```

```{r summariseModel3a1, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5, echo=FALSE}
...
#### Fixed effects
```{r posteriors3a1, results='markdown', eval=TRUE, hidden=TRUE, fig.width=6, fig.height=3}
brinla::bri.fixed.plot(fert.inla1)
```

#### Hyperparameters

```{r posteriors3a2, results='markdown', eval=TRUE, hidden=TRUE, fig.width=4, fig.height=3}
...
```{r posteriors3b, results='markdown', eval=TRUE, hidden=TRUE, fig.width=4, fig.height=3}
...
```{r posteriors3c, results='markdown', eval=TRUE, hidden=TRUE, fig.width=4, fig.height=3}
...
```{r posteriors3d, results='markdown', eval=TRUE, hidden=TRUE, fig.width=4, fig.height=3}
...
```{r posteriors3e, results='markdown', eval=TRUE, hidden=TRUE, fig.width=4, fig.height=3}
fert.draws %>%
...
```{r posteriors3f, results='markdown', eval=TRUE, hidden=TRUE, fig.width=4, fig.height=3}
fert.draws %>%
    filter(grepl('Intercept|FERTILIZER', Parameter)) %>%
    group_by(Parameter) %>%
    nest() %>%
...
```{r posteriors3g, results='markdown', eval=TRUE, hidden=TRUE, fig.width=4, fig.height=3}
fert.draws %>%
    filter(grepl('Intercept|FERTILIZER', Parameter)) %>%
...
```{r posteriors3h, results='markdown', eval=TRUE, hidden=TRUE, fig.width=4, fig.height=3}
...
```{r predictions0a, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r predictions1b, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
fert.rstanarm3 %>% emmeans(~FERTILIZER,  at=newdata)
```

### predicted values

```{r predictions1a, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r predictions1c, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r predictions1d, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r predictions1h, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r predictions2b, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
fert.brm3 %>%
...
```{r predictions2c, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r predictions2d, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r predictions2e, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r predictions2h, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
## Establish an appropriate model matrix
Xmat = model.matrix(~FERTILIZER, data=newdata)
### get the posterior draws for the linear predictor
coefs <- fert.brm3 %>%
...
```{r Probability1bb, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5,paged.print=FALSE}
...
```{r Probability1c2, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5, echo=1:2}
newdata <- list(FERTILIZER=c(200, 100)) 
...
- the percentage change in Yield associated with an increase in Fertilizer concentration
  from 100 to 200 is `r fert.mcmc %>% median_hdci(PEff) %>% '['(1, 1) %>% as.numeric %>% round(2)`% 
  with a 95% credibility interval of 
  `r fert.mcmc %>% median_hdci(PEff) %>% '['(1, 2) %>% as.numeric %>% round(2)`
  `r fert.mcmc %>% median_hdci(PEff) %>% '['(1, 3) %>% as.numeric %>% round(2)`
...
- the probability that Yield will increase by more than 50 following an increase
  ...
  `r fert.mcmc %>% summarise(P=sum(PEff>50)/n()) %>% as.numeric() %>% round(2)`.
...
```{r Probability1i, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
 newdata = list(FERTILIZER=c(200, 100)) 
 fert.rstanarm3 %>%
     emmeans(~FERTILIZER,  at=newdata) %>%
     pairs() %>%
...
```{r Probability1j, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
 newdata = list(FERTILIZER=c(200, 100)) 
 ## Simple
 fert.rstanarm3 %>%
     emmeans(~FERTILIZER,  at=newdata) %>%
...
```{r Probability1k, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
fert.rstanarm3 %>%
...
```{r Probability2c, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5,paged.print=FALSE}
...
```{r Probability2bb, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5,paged.print=FALSE}
0.1 * sd(fert$YIELD)/sd(fert$FERTILIZER)
## Cannot pipe to rope if want to pipe rope to plot()
...
```{r Probability2c1, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5, echo=1:2}
newdata <- list(FERTILIZER = c(200, 100)) 
fert.brm3 %>%
    emmeans(~FERTILIZER,  at = newdata) %>%
    pairs()
...
```{r Probability2c2, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5, echo=1:2}
newdata <- list(FERTILIZER=c(200, 100)) 
fert.brm3 %>%
    emmeans(~FERTILIZER,  at=newdata) %>%
    regrid(transform = "log") %>%
...
```{r Probability2ff, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
fert.mcmc %>%
    ggplot() +
...
```{r Probability2i, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
newdata = list(FERTILIZER=c(200, 100)) 
fert.brm3 %>%
    emmeans(~FERTILIZER,  at=newdata) %>%
    pairs() %>%
...
```{r Probability2j, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
newdata = list(FERTILIZER=c(200, 100)) 
## Simple
fert.brm3 %>%
    emmeans(~FERTILIZER,  at=newdata) %>%
...
```{r Probability2k, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
fert.brm3 %>%
    linpred_draws(newdata = as.data.frame(newdata)) %>%
    ungroup() %>%
    group_by(.draw) %>%
...
```{r summaryFig1b, results='markdown', eval=TRUE, hidden=TRUE}
fert.list = with(fert, list(FERTILIZER = seq(min(FERTILIZER), max(FERTILIZER), len=100)))
newdata = emmeans(fert.rstanarm3, ~FERTILIZER, at=fert.list) %>% as.data.frame
head(newdata)
...
```{r summaryFig2b, results='markdown', eval=TRUE, hidden=TRUE}
fert.list = with(fert, list(FERTILIZER = seq(min(FERTILIZER), max(FERTILIZER), len=100)))
