...
- $\beta_0$: Normal prior centred at 0 with a variance of 10
...
- for the intercept, it is using a normal prior with a mean of 0.53 and a
...
normal prior centred around 0 with a standard deviation of 2.5.  For binomial
models, this is then
...
-  there is no auxiliary parameter and thus there is no auxiliary prior 
### Assessing priors
...
- $\beta_0$: normal centred at 0.5 with a standard deviation of 10
...
- $\beta_0$: normal centred at 0 with a standard deviation of 10
- $\beta_1$: normal centred at 0 with a standard deviation of 1

I will also overlay the raw data for comparison.

Note that on the logit scale, a normal distribution with mean of 0 and
standard deviation of 10 is huge...
