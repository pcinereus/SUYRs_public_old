...
```{r summariseModel2c11, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
peake.brm4 %>%
...
```{r Probability1c, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5, echo=1:5}
...
```{r Probability2c, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5, echo=1:5}
newdata = list(AREA=c(5000, 10000)) 
## fractional scale
