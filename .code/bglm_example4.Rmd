...
```{r fitModel1a1, results='markdown', eval=TRUE, hidden=TRUE, cache=TRUE}
loyn.rstanarm = stan_glm(ABUND ~ scale(log(DIST))+
                              scale(log(LDIST))+
                              scale(log(AREA))+
                              fGRAZE+
...
```{r modelValidation1l, results='markdown', eval=TRUE, hidden=TRUE, fig.width=6, fig.height=12}
...
```{r modelValidation1m, results='markdown', eval=TRUE, hidden=TRUE, fig.width=6, fig.height=12}
...
```{r modelValidation2l, results='markdown', eval=TRUE, hidden=TRUE, fig.width=6, fig.height=12}
...
```{r modelValidation2m, results='markdown', eval=TRUE, hidden=TRUE, fig.width=6, fig.height=12}
...
```{r partialPlot2b, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=8, cache = TRUE}
loyn.brm3 %>%
...
```{r summariseModel1d3, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
loyn.rstanarm3$stanfit %>%
    summarise_draws(
        ~ median(exp(.x)),
...
```{r furtherModel2b, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5,echo=TRUE, cache = TRUE}
...
```{r furtherModel2c, results='markdown', cache=FALSE, eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5,echo=TRUE}
