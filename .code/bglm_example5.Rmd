...
```{r summariseModel2c4a, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5,echo=TRUE}
day.brm3 %>% 
  gather_draws(`.Intercept.*|.*TREAT.*`, regex=TRUE) %>% 
  ggplot() + 
  stat_halfeye(aes(x=.value,  y=.variable)) +
...
```{r Probability1a, results='markdown', echo=1,eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r Probability1b, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r Probability2a, results='markdown', echo=TRUE,eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
day.brm3 %>%
...
```{r Probability2b, results='markdown', eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
...
```{r Probability1c, results='markdown', echo=TRUE, eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
##Planned contrasts
...
```{r Probability2c, results='markdown', echo=TRUE, eval=TRUE, hidden=TRUE, fig.width=8, fig.height=5}
##Planned contrasts
cmat<-cbind('Alg2_Alg1' = c(-1,1,0,0),
            'NB_S' = c(0,0,1,-1),
            'Alg_Bare' = c(0.5,0.5,-0.5,-0.5),
...
```{r summaryFig1a, results='markdown', eval=TRUE, hidden=TRUE, fig.width=6, fig.height=3}
...
```{r summaryFig2a, results='markdown', eval=TRUE, hidden=TRUE, fig.width=6, fig.height=3}
newdata <- day.brm3 %>%
    emmeans(~TREAT, type='response') %>%
    as.data.frame
newdata
