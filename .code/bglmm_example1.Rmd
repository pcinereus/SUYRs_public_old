...
- $\beta_0$: normal centered at 35 with a standard deviation of 10
- $\beta_1$: normal centered at 0 with a standard deviation of 10
- $\sigma$: exponential with rate of 0.1
- $\Sigma$: decov with:
