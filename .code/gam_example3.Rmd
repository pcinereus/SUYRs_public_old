...
- the intercept (expected DOC concentration) in the average year is estimated to
  be `r round(summary(wq.gam1)$p.table[1, 1], 2)`
- there is no inferential evidence of a trend in DOC over time.
...
- there is evidence of a non-linear trend in DOC over time. 
...
<div class='HIDDEN'>
It is likely that DOC levels vary throughout a year.  This might be related to
...
- including a categorical variable for coding season.  This would allow us to
  ...
  be appropriate if we believe that there is a substantial difference in DOC
...
- there is evidence of a long-term non-linear trend in DOC.
- there is also evidence of a non-linear trend in DOC within a year
...
- there is evidence of a long-term non-linear trend in DOC in each of the three
  Regions (although they are most wiggly in the Wet Tropics and Burdekin).
- there is also evidence of a non-linear trend in DOC within a year for the
...
The partial plots within each Region suggested that DOC concentrations peaked
...
- the DOC concentration in 2014 was `r round(wq.emmeans[2, 2], 2)`
- the DOC concentration in 2016 was `r round(wq.emmeans[1, 2], 2)`
- between 2014 and 2016, DOC concentrations in open coastal waters of the GBR
...
- the DOC concentration in 2014 was `r round(wq.emmeans[6, 3], 2)` (Wet Tropics),
  `r round(wq.emmeans[2, 3], 2)` (Burdekin) and 
  `r round(wq.emmeans[4, 3], 2)` (Mackay-Whitsunday) 
- the DOC concentration in 2016 was `r round(wq.emmeans[5, 3], 2)` (Wet Tropics),
