...
```{r fitModel1a, cache=TRUE,results='markdown', eval=TRUE, hidden=TRUE}
...
```{r fitModel1b, cache=TRUE,results='markdown', eval=TRUE, hidden=TRUE}
...
```{r fitModel1c1, cache=TRUE,results='markdown', eval=FALSE, echo=FALSE, hidden=TRUE}
...
```{r fitModel1c, cache=TRUE,results='markdown', eval=TRUE, hidden=TRUE}
...
```{r fitModel1d, cache=TRUE,results='markdown', eval=TRUE, hidden=TRUE}
...
```{r fitModel1e, cache=TRUE,results='markdown', echo=FALSE, eval=FALSE, hidden=TRUE}
...
```{r fitModel1f, cache=TRUE,results='markdown', eval=TRUE, hidden=TRUE}
...
```{r fitModel1g, cache=TRUE,results='markdown', eval=TRUE, hidden=TRUE}
...
```{r fitModel1h, cache=TRUE,results='markdown', eval=TRUE, hidden=TRUE}
...
```{r fitModel2a, cache=TRUE,results='markdown', eval=TRUE, hidden=TRUE}
...
```{r fitModel2b, cache=TRUE,results='markdown', eval=TRUE, hidden=TRUE, error=TRUE}
...
```{r validation1a, results='markdown', eval=TRUE, hidden=TRUE,warning=FALSE,message=FALSE}
...
```{r validation1b, results='markdown', eval=TRUE, hidden=TRUE,warning=FALSE,message=FALSE,fig.width=7,fig.height=7}
...
### DHARMa residuals
```{r validation1c, results='markdown', eval=TRUE, hidden=TRUE,warning=FALSE,message=FALSE,fig.width=7,fig.height=4}
...
```{r validation2a, results='markdown', eval=TRUE, hidden=TRUE,warning=FALSE,message=FALSE}
...
```{r validation2b, results='markdown', eval=TRUE, hidden=TRUE,warning=FALSE,message=FALSE,fig.width=7,fig.height=7}
...
### DHARMa residuals
```{r validation2c, results='markdown', eval=TRUE, hidden=TRUE,warning=FALSE,message=FALSE,fig.width=7,fig.height=4}
